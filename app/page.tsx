...
import { VotesProvider } from "@/components/VotesContext";
      ...
      <div
        ...
        style={{
          background:
            ...
            "radial-gradient(40% 30% at 85% 5%, rgba(106,173,196,0.10) 0%, transparent 60%)",
        }}
      />

      <VotesProvider initialVotes={votes}>
        <PhraseProvider>
          <WelcomeToast />
            ...
            <header className="flex items-end justify-between gap-4">
              <div className="space-y-1.5">
                ...
                <p className="max-w-2xl text-sm text-slate-400">
                  Play each synthesized voice and pick the one that sounds the
                  most like the real person. One vote per person.
                </p>
              </div>
